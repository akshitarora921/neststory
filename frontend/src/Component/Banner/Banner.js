        ...
        <div className="container-fluid">
          <div className="row">
            {this.state.banners.map((banner, id) => {
              //  console.log(id)
              let styleCol, styleRow;
              if (id == 0 || id == 3) styleCol = "col-4";
              else styleCol = "col-6";

              if (id == 0 || id == 2) styleRow = "row";
              else styleRow = "";
              return (
                //  <div className={`${styleRow}`}>
                <div
                  style={{
                    backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3)),url(http://localhost:3001/image/banner/${banner.image})`,
                  }}
                  className={`${styleCol} bannerImage`}
                >
                  {banner.isVideo==1 && (<i className="far fa-play-circle fa-3x playButton1" />)}
                  <div className="h6 bannerHeading">
                  {banner.caption}
                  </div>
